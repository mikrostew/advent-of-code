...
Collecting ore requires **ore-collecting robots** with big drills. Fortunately, **you have exactly one ore-collecting robot** in your pack that you can use to [kickstart](# "If You Give A Mouse An Ore-Collecting Robot") the whole operation.
