...
Because of how quickly the lava is moving, the scan isn't very good; its resolution is quite low and, as a result, it approximates the shape of the lava droplet with **1x1x1 [cubes](# "Unfortunately, you forgot your flint and steel in another dimension.") on a 3D grid**, each given as its `x,y,z` position.
